...
namespace Com
{
    ...
    public class ConnDB : DbContext
    {
        ...
        /// <summary>
        /// 重载RunProcedureRdataSet把执行存储过程的结果放在DataSet中
        /// </summary>
        /// <param name="storedProcName"></param>
        /// <param name="parameters"></param>
        /// <returns></returns>
        public DataSet RunProcedureRdataSet(string storedProcName)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public DataSet RunProcedureRdataSet(string storedProcName, IDataParameter[] parameters)
        {
            DataSet dataSet = new DataSet();
            Connection.Open();
            SqlDataAdapter sqlDA = new SqlDataAdapter();
